...
Script pricing is where a covenant's transition policy meets validation resources.

The transaction can be structurally valid and still fail script execution. If the active input runs out of committed execution room, validation fails.
