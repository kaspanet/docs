...
This minimal guest increments each touched resource. The pattern matters more than the logic: the host feeds encoded inputs, the guest updates resources, and the journal becomes material for later proof composition.
